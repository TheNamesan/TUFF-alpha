...
namespace TUFF
{
    [CreateAssetMenu(fileName = "Weapon", menuName = "Database/Weapon", order = 6)]
    public class Weapon : InventoryItem, IEquipable
    {
        [Header("General Settings")]
        [Tooltip("Name localization key from the Weapon Table Collection.")]
        public string nameKey = "name_key";
        [Tooltip("Description localization key from the Weapon Table Collection.")]
