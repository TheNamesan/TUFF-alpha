...
namespace TUFF
{
    ...
    public class State : DatabaseElement
    {
        ...
        public string customDetailedDescriptionKey = "detailed_key";
        ...
        public string GetCustomDetailedDescription()
        {
            return TUFFTextParser.ParseText(customDetailedDescriptionKey);
        }
    }
}
