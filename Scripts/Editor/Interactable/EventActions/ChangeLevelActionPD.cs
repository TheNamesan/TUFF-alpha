...
{
    [CustomPropertyDrawer(typeof(ChangeLevelAction))]
    public class ChangeLevelActionPD : EventActionPD
    {
        ...
        {
            var action = targetObject as ChangeLevelAction;
            ...
            return $"{scope}'s Level {amountText}";
        }
    }
}
