...
{
    [CustomPropertyDrawer(typeof(ChangeHPAction))]
    public class ChangeHPActionPD : EventActionPD
    {
        ...
        {
            var action = targetObject as ChangeHPAction;
            ...
            return $"{scope}'s HP {operation}{value}";
        }
    }
}
