...
{
    [CustomEditor(typeof(UIPicker)), CanEditMultipleObjects]
    public class UIPickerEditor : Editor
    {
        bool showActions = true;
        bool showOtherActions = false;
        override public void OnInspectorGUI()
        {
            var element = target as UIPicker;
            ...
            EditorGUILayout.PropertyField(serializedObject.FindProperty("highlightedOption"));
